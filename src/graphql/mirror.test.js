  ...
  describe("Mirror", () => {
    ...
    describe("extract", () => {
      ...
      it("handles a representative normal case", () => {
        ...
        mirror._updateConnection(update1, objects.issue1().id, "comments", {
          totalCount: 0,
          pageInfo: {
            endCursor: null,
            hasNextPage: false,
        ...
        mirror._updateConnection(update1, objects.issue2().id, "comments", {
          totalCount: 0,
          pageInfo: {
            endCursor: null,
            hasNextPage: false,
        ...
        // comment on issue #2. Issue #2 is loaded as a child of the
        // repository.
        ...
        // but not yet added to the repository connection.
